...
public class RegisterClientActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void init(){
        this.etName = (EditText)findViewById(R.id.etRegisterClientName);
        this.etEmail = (EditText)findViewById(R.id.etRegisterClientEmail);
        this.etPass = (EditText)findViewById(R.id.etRegistarClientPassword);
        this.etPass2 = (EditText)findViewById(R.id.etRegisterClientPassword2);
        this.etBirthday = (EditText)findViewById(R.id.etRegisterBirthdayClient);
    ...
    private void RegisterClient(){
        if(this.etPass.getText().toString()==this.etPass2.getText().toString()) {
